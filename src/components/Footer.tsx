  ...
  return <footer className="bg-white py-12 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h4 className="text-xl font-light mb-4 font-['Roboto'] text-charcoal">Beaufoy</h4>
            <p className="text-charcoal font-['roboto']">
              A full-service communications agency for luxury consumer brands.
            </p>
          </div>

          <div>
            <h4 className="text-xl font-light mb-4 font-['Roboto'] text-charcoal">Services</h4>
            <ul className="space-y-2 text-charcoal font-['roboto']">
          ...
          <div>
            <h4 className="text-xl font-light mb-4 font-['Roboto'] text-charcoal">Contact</h4>
            <address className="text-charcoal not-italic font-['roboto']">
              <p>123 Luxury Lane</p>
              <p>London, UK</p>
