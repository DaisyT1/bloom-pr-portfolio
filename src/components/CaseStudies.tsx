      ...
      <div className="flex flex-col md:flex-row gap-8 items-center">
        <div className="md:w-1/3 w-full">
          <img
            src={imageSrc}
            alt={imageAlt}
            className="rounded-lg shadow-md w-full h-auto object-cover aspect-square md:aspect-auto"
          />
        </div>
  ...
  return <section id="case-studies" className="px-6 md:px-12 py-[16px] bg-zinc-50">
      <div className="max-w-7xl mx-auto">
        ...
        <CaseStudy 
          ...
          imageSrc="/atlanticws.png" 
          imageAlt="Atlantic Money logo" 
