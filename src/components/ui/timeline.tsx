...
export const Timeline = ({
  ...
  return <div className="w-full bg-offwhite px-4 md:px-10 font-roboto" ref={containerRef}>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10 py-[99px]">
        ...
        }} className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-[#FFDEE2] via-[#E5DEFF] to-transparent from-[0%] via-[10%] rounded-full" />
        </div>
      </div>
    </div>;
};